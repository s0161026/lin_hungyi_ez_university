...
class Semester(models.Model):
    ...
    # on_delete: dont want any delete cascade (delete detailed items)
    ...
    def __str__(self):
        # tuple and not just combine them (self->year table->year field, )
    ...
    class Meta:
        # take year field from year model class and so does period
        # unique as a group
...
class Section(models.Model):
    ...
    # on_delete=models.PROTECT - dont want sql cascade(delete both side of data)
    ...
    def __str__ (self):
        # point to semester to the sting itself
