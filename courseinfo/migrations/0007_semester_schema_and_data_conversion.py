# Generated by Django 2.2.1 on 2019-10-25 06:21
...
def extract_year(semester_name):
    ...
    if len(answer) != 1:
        # raise Exception keeps non-commit, rolls back
...
# generate the empty one since it hooked with the previous one
class Migration(migrations.Migration):

    dependencies = [
        ('courseinfo', '0006_year_schema_data'),
    ]
    ...
    operations = [
        ...
        # add year field to the semester model
        # when we do the conversion and dont know what value to put,we put id = 1, value 9999
        migrations.AddField(
            model_name='semester',
            name='year',
        ...
        # hook with new semester class and remove 9999 in semester
        migrations.RunPython(
            forward_convert_semester_data,
            reverse_convert_semester_data
        ),

        # remove 9999 from period and year table
        migrations.RunPython(
        ...
        # remove old semester name, already converted
