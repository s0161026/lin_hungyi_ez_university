# Generated by Django 2.2.1 on 2019-10-25 02:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courseinfo', '0003_auto_20191024_1010'),
    ]

    operations = [
        migrations.RunPython(
            add_semester_data,  # Runnning forward (applying data)
            remove_semester_data  # Running backward (unapplying data)
        )
    ]
